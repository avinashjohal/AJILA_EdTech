...
function AddInternship() {
  ...
  const formSubmit = () => {
    ...
    _formData.append("category", internshipData.category); // Send the category ID
    _formData.append("teacher", 1);
    _formData.append("title", internshipData.title);
    _formData.append("description", internshipData.description);
    _formData.append("featured_img", internshipData.featured_img, internshipData.featured_img.name);
    _formData.append("techs", internshipData.techs);
    _formData.append("duration", internshipData.duration);

    try {
      axios.post(baseUrl + "/internship/", _formData, {
        headers: {
    ...
    <div className="container mt-4">
      <div className="row">
        ...
        <section className="col-md-9">
          <div className="card">
            <h5 className="card-header">Add Internship</h5>
